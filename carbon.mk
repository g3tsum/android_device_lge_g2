...
# device
$(call inherit-product-if-exists, device/lge/g2/g2.mk)
...
PRODUCT_DEVICE := g2
PRODUCT_BRAND := LGE
PRODUCT_NAME := carbon_g2
PRODUCT_MODEL := LG-G2
PRODUCT_MANUFACTURER := LGE
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=carbon.g2.$(shell date +%m%d%y).$(shell date +%H%M%S)
